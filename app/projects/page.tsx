...
export const metadata: Metadata = {
    title: "Gourav Banswal's Projects",
    description: "Web developer projects using HTML, CSS, JavaScript, Node.js, React, Redux, and Tailwind CSS.",
    keywords: ["HTML", "CSS", "JavaScript", "Node.js", "React", "Redux", "Tailwind CSS", "web development", "projects"],
    authors: [
        {name: "Gourav Banswal", url: "GITHUB LINK" }
    ] 
 }
const page = () => {
  return <>
